...
func TestResponse_ErrorResponse(t *testing.T) {
	tests := []struct {
		...
		{"error response with raw body", &ErrorResponse{rawBody: &RawBody{Status: 1, Message: "info"}}, "code: 1, info: info", nil, true},                                                              //nolint:lll
		...
		{"error response with http response and raw body", &ErrorResponse{response: &http.Response{StatusCode: 404}, rawBody: &RawBody{Status: 1, Message: "info"}}, "code: 1, info: info", nil, true}, //nolint:lll
	}
